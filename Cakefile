...
task 'package:core', 'Build pkg/annotator.js', ->
  packager.build_coffee util.src_files(CORE), 'pkg/annotator.js'

task 'package:css', 'Build pkg/annotator.css', ->
  packager.build_css ['css/annotator.css'], 'pkg/annotator.css'

task 'package:plugins', 'Build pkg/annotator.<plugin_name>.js for all plugins', ->
  for p in PLUGINS
    packager.build_coffee util.src_files([p], 'plugin/'), "pkg/annotator.#{p}.js"
